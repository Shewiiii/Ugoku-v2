...
class Deezer:
    ...
    async def search(self, query, index=0, limit=10, suggest=True, artist_suggest=True, top_tracks=True) -> dict:
        return await self.gw_api_call('deezer.pageSearch', {
            "query": query,
            "start": index,
            "nb": limit,
            "suggest": suggest,
    ...
    async def get_track_urls(self, track_tokens: list, tracks_format: Literal['MP3_128', 'MP3_320', 'FLAC'] = 'FLAC') -> list[str]:
